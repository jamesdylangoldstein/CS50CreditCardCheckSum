...
int main(int argc, const char * argv[]) {
    ...
    unsigned long long countera, counterc, counterd, firstsumdigits, timesninemodzero, finalsum;
    unsigned long long counterb = creditcardlength - 1;
    ...
    for(counterc = creditcardlength - 1; counterc < 0; counterc - 2)
    {
        digitsarray[counterc] = digitsarray[counterc]*2;
